...
global hpBarSpotX:=0
global hpBarSpotY:=0
global hpColor:=0xE1EBF2

global mpBarSpotX:=0
global mpBarSpotY:=0
global mpColor:=0xE1EBF3

global monsterBarSpotX:=1080
global monsterBarSpotY:=46
global monsterColor:=0xE1EBF4
...
F10::
    ...
    ToolTip , Hp bar setted x: %hpBarSpotX% y: %hpBarSpotY% - %hpColor% Secondly Click mp bar when the mp pot will be used 
    KeyWait, LButton, D
    MouseGetPos, mpBarSpotX, mpBarSpotY
    Sleep, 200

    ToolTip , Mp bar setted x: %mpBarSpotX% y: %mpBarSpotY% - %mpColor% Lastly Click the red zone at the middle of the MonsterBar 
    KeyWait, LButton, D
    MouseGetPos, monsterBarSpotX, monsterBarSpotY
    Sleep, 200

    PixelGetColor, hpColor, %hpBarSpotX%, %hpBarSpotY%, SLOW 
    Sleep, 100
    PixelGetColor, mpColor, %mpBarSpotX%, %mpBarSpotY%, SLOW
    Sleep, 100
    PixelGetColor, monsterColor, %monsterBarSpotX%, %monsterBarSpotY%, SLOW
    Sleep, 100

    hexColorShow(hpColor)
    hexColorShow(mpColor)
    hexColorShow(monsterColor)
